...
typedef afc_operation* (*tf_AFCOperationCreateSetModTime)(
    CFAllocatorRef allocator,
    CFStringRef filename,
    uint64_t mtm,
    void *ctx);

typedef afc_error_t (*tf_AFCConnectionProcessOperation)(
    afc_connection* a1,
    afc_operation* op,
    double timeout);

typedef uint32_t (*tf_AFCConnectionGetIOTimeout)(
    afc_connection* conn);
